...
sd_instantiate_component -sd_name ${sd_name} -component_name {RESET_WRAPPER} -instance_name {RESET_CLK_150MHz_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EXT_RST_N" "RESET_CLK_150MHz:EXT_RST_N" "RESET_CLK_150MHz_0:EXT_RST_N" "RESET_CLK_200MHz:EXT_RST_N" "RESET_CLK_250MHz:EXT_RST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C0_0:OUT2_FABCLK_0" "RESET_CLK_150MHz:CLK" "clk_100MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C0_0:OUT3_FABCLK_0" "RESET_CLK_150MHz_0:CLK" "clk_150MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C0_0:PLL_LOCK_0" "RESET_CLK_150MHz:PLL_LOCK" "RESET_CLK_150MHz_0:PLL_LOCK" "RESET_CLK_200MHz:PLL_LOCK" "RESET_CLK_250MHz:PLL_LOCK" }
